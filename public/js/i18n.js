  ...
  const T = {
    ...
    fr: {
      nav: {
        ...
        shop_aria: 'Boutique', season_aria: 'Saison',
      },
      stats: {
        coins: 'Coins', gems: 'Gemmes', depth: 'Prof.',
        pickaxe: 'Pioche', damage: 'Dégâts', relics: '🔮 Frags',
      ...
      upgrade: {
        ...
        fragment_shop: { name: 'Fragments',   desc_none: 'Acheter 1 fragment de relique', desc: '{n}/10 achetés cette saison', },
        block_reroll:  { name: 'Reroll bloc', desc_none: 'Changer le bloc actuel', desc: '{n} changement{s} cette saison', },
      },
      quest: {
      ...
      relic: {
        ...
        level_label: 'Nv. {cur}/{max}',
        bonus_types: {
          damage_flat:          '+{n} dégât{s}/clic',
          coins_pct:            '+{n}% pièces',
          relic_fragment_bonus: '+{n} fragment{s}/coffre',
          luck_pct:             '+{n}% blocs rares',
          hp_reduction:         '-{n}% HP blocs',
          autodig_bonus:        '+{n} dégâts auto/sec',
        },
      },
      find: {
      ...
      ui: {
        ...
        ad_soon:             'Récompense bientôt disponible',
        ad_used:             'Bonus déjà utilisé',
        ...
        relic_header:         '{count}\u202f/\u202f{total} débloquée{s1}\u2002—\u2002🔮\u202f{frags} fragment{s2}',
        reward_label:         'Récompense',
        chest_loot:           'Contenu aléatoire',
        guest_warning:        'Connectez-vous pour sauvegarder votre progression !',
        ...
        section_shop_chests:       '🏪 Boutique de saison',
        btn_open_chest:            'Ouvrir',
        shop_chest_bought:         '{n}/{max} ouverts',
        shop_chest_limit_reached:  'Limite atteinte',
        shop_chest_opened:         '{name} ouvert !',
        shop_chest_error:          'Erreur lors de l\'ouverture du coffre.',
        ...
        relic_upgrade_cost: '🔮 {n} fragment{s} → Nv. {next}',
      },
      shop_chest: {
        simple:  { name: 'Coffre simple',  desc: 'Coins, fragments ou boost — petites récompenses garanties.' },
        rare:    { name: 'Coffre rare',    desc: "Meilleure chance d'obtenir des fragments et un objet de collection." },
        antique: { name: 'Coffre antique', desc: 'Jackpot de fragments possible. Limité à 5 ouvertures par saison.' },
      },
      notif: {
      ...
      season: {
        title:          'Saison',
        not_connected:  'Connectez-vous pour participer au classement !',
        not_active:     'Cassez au moins 1 bloc manuellement pour apparaître au classement.',
        rank:           'Rang #{n}',
        no_league:      'Non classé',
        depth_label:    'Prof. max',
        blocks_label:   'Blocs manuels',
        ends_in:        'Fin dans {d}j {h}h',
        new_season:     'Nouvelle saison ! Bonne chance à tous !',
        leaderboard:    'Classement',
        your_stats:     'Vos stats',
        loading:        'Chargement…',
        info: {
          toggle:      'ℹ️ Comment fonctionne la saison ?',
          intro:       'À la fin de chaque saison, coins, profondeur et améliorations sont remis à zéro. Gems, fragments, reliques et bonus permanents sont toujours conservés.',
          reset_title: '🔄 Remis à zéro',
          kept_title:  '✅ Conservé',
          r_coins:     'Coins',
          r_depth:     'Profondeur',
          r_upgrades:  'Améliorations',
          r_boosts:    'Boosts temporaires',
          r_rank:      'Classement',
          k_gems:      'Gems',
          k_frags:     'Fragments',
          k_relics:    'Reliques',
          k_bonuses:   'Bonus permanents',
        },
      },
    },
    ...
    en: {
      nav: {
        ...
        shop_aria: 'Shop', season_aria: 'Season',
      },
      stats: {
        coins: 'Coins', gems: 'Gems', depth: 'Depth',
        pickaxe: 'Pickaxe', damage: 'Damage', relics: '🔮 Frags',
      ...
      upgrade: {
        ...
        fragment_shop: { name: 'Fragments',    desc_none: 'Buy 1 relic fragment', desc: '{n}/10 bought this season', },
        block_reroll:  { name: 'Reroll block', desc_none: 'Change current block', desc: '{n} change{s} this season', },
      },
      quest: {
      ...
      relic: {
        ...
        level_label: 'Lv. {cur}/{max}',
        bonus_types: {
          damage_flat:          '+{n} damage{s}/click',
          coins_pct:            '+{n}% coins',
          relic_fragment_bonus: '+{n} fragment{s}/chest',
          luck_pct:             '+{n}% rare blocks',
          hp_reduction:         '-{n}% block HP',
          autodig_bonus:        '+{n} auto damage/sec',
        },
      },
      find: {
      ...
      ui: {
        ...
        ad_soon:             'Available soon',
        ad_used:             'Bonus already used',
        quest_claimed:        '✓ Claimed',
        relic_unlocked_badge: '✓ Unlocked',
        relic_shortfall:      '(missing\u202f{n})',
        relic_cost:           '🔮\u202f{n} fragment{s}',
        collection_header:    '{found}\u202f/\u202f{total} found',
        relic_header:         '{count}\u202f/\u202f{total} unlocked\u2002—\u2002🔮\u202f{frags} fragment{s2}',
        reward_label:         'Reward',
        chest_loot:           'Random contents',
        guest_warning:        'Sign in to save your progress!',
        ...
        relic_upgrade_cost: '🔮 {n} fragment{s} → Lv. {next}',
        section_shop_chests:       '🏪 Season Shop',
        btn_open_chest:            'Open',
        shop_chest_bought:         '{n}/{max} opened',
        shop_chest_limit_reached:  'Limit reached',
        shop_chest_opened:         '{name} opened!',
        shop_chest_error:          'Error opening chest.',
      },
      notif: {
      ...
      season: {
        title:          'Season',
        not_connected:  'Sign in to join the leaderboard!',
        not_active:     'Break at least 1 block manually to appear in the rankings.',
        rank:           'Rank #{n}',
        no_league:      'Unranked',
        depth_label:    'Max depth',
        blocks_label:   'Manual blocks',
        ends_in:        'Ends in {d}d {h}h',
        new_season:     'New season! Good luck everyone!',
        leaderboard:    'Leaderboard',
        your_stats:     'Your stats',
        loading:        'Loading…',
        info: {
          toggle:      'ℹ️ How does the season work?',
          intro:       'At the end of each season, coins, depth and upgrades are reset. Gems, fragments, relics and permanent bonuses are always kept.',
          reset_title: '🔄 Reset',
          kept_title:  '✅ Kept',
          r_coins:     'Coins',
          r_depth:     'Depth',
          r_upgrades:  'Upgrades',
          r_boosts:    'Temp. boosts',
          r_rank:      'Ranking',
          k_gems:      'Gems',
          k_frags:     'Fragments',
          k_relics:    'Relics',
          k_bonuses:   'Permanent bonuses',
        },
      },
    },
    ...
    nl: {
      nav: {
        ...
        shop_aria: 'Winkel', season_aria: 'Seizoen',
      },
      stats: {
        coins: 'Munten', gems: 'Edelst.', depth: 'Diepte',
        pickaxe: 'Houweel', damage: 'Schade', relics: '🔮 Frags',
        depth_val: '{n}m', pickaxe_val: 'Nv.{n}',
      },
      rarity: {
      ...
      upgrade: {
        ...
        fragment_shop: { name: 'Fragmenten',   desc_none: '1 reliek fragment kopen', desc: '{n}/10 gekocht dit seizoen', },
        block_reroll:  { name: 'Blok opnieuw', desc_none: 'Huidig blok veranderen', desc: '{n} wissel{s} dit seizoen', },
      },
      quest: {
      ...
      relic: {
        ...
        level_label: 'Nv. {cur}/{max}',
        bonus_types: {
          damage_flat:          '+{n} schade/klik',
          coins_pct:            '+{n}% munten',
          relic_fragment_bonus: '+{n} scherf{s}/kist',
          luck_pct:             '+{n}% zeldzame blokken',
          hp_reduction:         '-{n}% blok HP',
          autodig_bonus:        '+{n} auto schade/sec',
        },
      },
      find: {
      ...
      ui: {
        ...
        ad_soon:             'Binnenkort beschikbaar',
        ad_used:             'Bonus al gebruikt',
        ...
        relic_header:         '{count}\u202f/\u202f{total} ontgrendeld\u2002—\u2002🔮\u202f{frags} scherf{s2}',
        reward_label:         'Beloning',
        chest_loot:           'Willekeurige inhoud',
        guest_warning:        'Log in om je voortgang op te slaan!',
        ...
        relic_upgrade_cost: '🔮 {n} scherf{s} → Nv. {next}',
        section_shop_chests:       '🏪 Seizoenswinkel',
        btn_open_chest:            'Openen',
        shop_chest_bought:         '{n}/{max} geopend',
        shop_chest_limit_reached:  'Limiet bereikt',
        shop_chest_opened:         '{name} geopend!',
        shop_chest_error:          'Fout bij openen van kist.',
      },
      notif: {
      ...
      season: {
        title:          'Seizoen',
        not_connected:  'Log in om deel te nemen aan het klassement!',
        not_active:     'Breek minstens 1 blok handmatig om in het klassement te verschijnen.',
        rank:           'Rang #{n}',
        no_league:      'Niet geklasseerd',
        depth_label:    'Max diepte',
        blocks_label:   'Handmatige blokken',
        ends_in:        'Eindigt over {d}d {h}h',
        new_season:     'Nieuw seizoen! Veel succes!',
        leaderboard:    'Klassement',
        your_stats:     'Jouw stats',
        loading:        'Laden…',
        info: {
          toggle:      'ℹ️ Hoe werkt het seizoen?',
          intro:       'Aan het einde van elk seizoen worden munten, diepte en verbeteringen gereset. Edelstenen, fragmenten, relikwieën en permanente bonussen blijven altijd bewaard.',
          reset_title: '🔄 Gereset',
          kept_title:  '✅ Behouden',
          r_coins:     'Munten',
          r_depth:     'Diepte',
          r_upgrades:  'Verbeteringen',
          r_boosts:    'Tijdelijke boosts',
          r_rank:      'Klassement',
          k_gems:      'Edelstenen',
          k_frags:     'Fragmenten',
          k_relics:    'Relikwieën',
          k_bonuses:   'Permanente bonussen',
        },
      },
    },
